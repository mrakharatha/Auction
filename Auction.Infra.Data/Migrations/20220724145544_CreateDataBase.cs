        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceiveStatus = table.Column<bool>(type: "bit", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "CategoryId", "Banner", "CategoryName", "Image" },
                values: new object[,]
                {
                    { 1, "/assets/images/auction/car/car-bg.png", "خودرو", "/assets/images/auction/01.png" },
                    { 2, "/assets/images/auction/jewelry/jwelry-bg.png", "جواهر سازی", "/assets/images/auction/02.png" },
                    { 3, "/assets/images/auction/coins/coin-bg.png", "سکه", "/assets/images/auction/07.png" },
                    { 4, "/assets/images/auction/realstate/real-bg.png", "املاک", "/assets/images/auction/06.png" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "Avatar", "Email", "FullName", "Password", "RegisterDate" },
                values: new object[] { 1, "client02.png", "superadmin@gmail.com", "ادمین سیستم", "pmWkWSBCL51Bfkhn79xPuKBKHz//H6B+mY6G9/eieuM=", new DateTime(2022, 7, 18, 12, 56, 32, 968, DateTimeKind.Local).AddTicks(1379) });
